...
const EditHealthData = () => {
  ...
  const onChangeBP = (value: any, healthName: any) => {
      ...
      <form className={styless['user-form']}>
        ...
        <div className={styless['form-control']}>
          ...
          <input
            ...
            onChange={(e) => onChangeBP(e.target.value, 'BP')}
            id="BP"
        ...
        <div className={styless['form-control']}>
          ...
          <input
            ...
            onChange={(e) => onChangeBP(e.target.value, 'HR')}
            id="HR"
        ...
        <div className={styless['form-control']}>
          ...
          <input
            ...
            onChange={(e) => onChangeBP(e.target.value, 'SBP')}
            id="SBP"
        ...
        <div className={styless['form-control']}>
          ...
          <input
            ...
            onChange={(e) => onChangeBP(e.target.value, 'DBP')}
            id="DBP"
        ...
        <div className={styless['form-control']}>
          ...
          <input
            ...
            onChange={(e) => onChangeBP(e.target.value, 'PR')}
            id="PR"
        ...
        <div className={styless['form-control']}>
          ...
          <input
            ...
            onChange={(e) => onChangeBP(e.target.value, 'SR')}
            id="SR"
